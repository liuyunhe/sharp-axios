...
```bash
$ npm install @shepardliu/sharp-axios
```

Using bower:

```bash
$ bower install @shepardliu/sharp-axios
```

Using yarn:

```bash
$ yarn add @shepardliu/sharp-axios
```

Using pnpm:

```bash
$ pnpm add @shepardliu/sharp-axios
```

Once the package is installed, you can import the library using `import` or `require` approach:

```js
import axios, {isCancel, AxiosError} from '@shepardliu/sharp-axios';
```

You can also use the default export, since the named export is just a re-export from the Axios factory:

```js
import axios from '@shepardliu/sharp-axios';
...
```js
const axios = require('@shepardliu/sharp-axios');
